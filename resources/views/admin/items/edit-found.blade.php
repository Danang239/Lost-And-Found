...
@section('content')
    ...
    <div class="mb-8 flex items-center gap-3">
        ...
        <div>
            ...
            <p class="text-sm text-slate-500 mt-1">
                Perbarui informasi agar proses kecocokan dan klaim lebih akurat.
            </p>
        </div>
    </div>
    ...
    {{-- FORM TANPA BOX --}}
    <form 
        action="{{ route('admin.items.update-found', $item->id) }}"
        method="POST"
        ...
        {{-- CIRI-CIRI --}}
        <div class="space-y-1">
            <label for="features" class="block text-sm font-semibold text-slate-800">
                Pertanyaan / Ciri-ciri Barang
            </label>
            <textarea
                name="features"
                id="features"
            ...
            <p class="text-[11px] text-slate-400">
                Contoh: tulisan di lanyard, warna detail, stiker, kerusakan tertentu.
            </p>
        ...
        {{-- FOTO --}}
        <div class="space-y-1">
            <label for="image" class="block text-sm font-semibold text-slate-800">Foto Barang</label>
            ...
            <p class="text-[11px] text-slate-400">Format: JPG/PNG — Maksimal 2MB</p>
            @error('image')
                <p class="text-red-500 text-xs">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="flex justify-end pt-4 gap-3">
            ...
            {{-- CANCEL → Dashboard Barang Ditemukan --}}
